  ...
  return (
    <header className="hero">
      ...
      <div className="hero-inner">
        ...
        {/* Hexágono mobile — aparece só em telas pequenas */}
        <div className="hero-hex-mobile">
          <svg width="80" height="90" viewBox="0 0 180 200" xmlns="http://www.w3.org/2000/svg" style={{ filter: 'drop-shadow(0 0 10px rgba(20, 184, 212, 0.3))' }}>
            <polygon points="90,30 160,70 90,110 20,70" fill="rgba(20, 184, 212, 0.07)" stroke="#14b8d4" strokeWidth="1.5"/>
